...
export const AuthPage: React.FC<AuthPageProps> = ({
  ...
  const handleGoogleSignIn = async () => {
    ...
    if (isGoogleOAuthEnabled === false) {
      setErrorMsg('Google Sign-In is not enabled on this Supabase project yet. Please create an account or sign in with your email and password below.');
      return;
    }
        ...
        {(tab === 'login' || tab === 'signup') && (
          <div className="space-y-3 pt-1">
            <button
              ...
              className="w-full py-2.5 px-4 rounded-xl border border-stone-200 bg-stone-50 hover:bg-stone-100 text-xs font-semibold text-stone-700 flex items-center justify-center gap-2.5 transition-all shadow-2xs cursor-pointer disabled:opacity-60 relative group"
